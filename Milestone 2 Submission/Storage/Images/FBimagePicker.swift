...
struct FBimagePicker: UIViewControllerRepresentable {
    
    @Binding var shown: Bool
    @Binding var imageURL:String
    
    func makeCoordinator() -> FBimagePicker.Coordinator {
        return FBimagePicker.Coordinator(parent: self)
    }
    
    class Coordinator: NSObject,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
        var parent: FBimagePicker
        let storage = Storage.storage().reference()
        init(parent: FBimagePicker) {
            self.parent = parent
        }
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<FBimagePicker>) -> UIImagePickerController {
    ...
    func updateUIViewController(_ uiViewController: UIImagePickerController, context: UIViewControllerRepresentableContext<FBimagePicker>) {
    }
}
